...
@section('content')
    ...
    <script>
        const initialInternships = @json($internships);
    </script>
    ...
    <p id="empty-message" class="px-6 mt-5">インターンシップが登録されていません。</p>

    <div class="mx-auto max-w-6xl rounded-lg p-8">
        <div id="internship-list" class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 items-start">
        </div>
    </div>
    ...
    <template id="internship-card-template">
        <div class="bg-white rounded-lg shadow p-6">
            <div class="flex justify-between items-start">
                <div class="w-full">
                    <div class="flex justify-between items-start border-b mb-2 w-full">
                        <p class="internship-name text-xl font-bold truncate min-w-0"></p>
                        <div class="flex items-center gap-2 shrink-0 ml-2">
                            <a class="edit-link cursor-pointer hover:text-emerald-500">
                            ...
                            <button type="button" class="delete-button cursor-pointer hover:text-red-500">
                                <svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" viewBox="0 0 24 24">
                                    <path fill="currentColor"
                                        d="M7 21q-.825 0-1.412-.587T5 19V6q-.425 0-.712-.288T4 5t.288-.712T5 4h4q0-.425.288-.712T10 3h4q.425 0 .713.288T15 4h4q.425 0 .713.288T20 5t-.288.713T19 6v13q0 .825-.587 1.413T17 21z" />
                                </svg>
                            </button>
                        </div>
                    </div>
                    <p>
                        <strong>企業：</strong>
                        <span class="internship-company"></span>
                    </p>
                    <p>
                        <strong>日程：</strong>
                        <span class="internship-datetime"></span>
                    </p>
                    <div class="internship-url"></div>
                    <p>
                        <strong>応募状況：</strong>
                        <span class="internship-applied"></span>
                    </p>
                    <p>
                        <strong>参加状況：</strong>
                        <span class="internship-joined"></span>
                    </p>
                </div>
            </div>
            <details class="mt-4 group">
                <summary class="cursor-pointer font-semibold list-none">
                    <span class="group-open:hidden font-semibold text-blue-500 hover:text-blue-800 hover:underline">
                        ▼ 詳細を見る
                    </span>
                </summary>
                <div class="mt-3 space-y-2">
                    <p>
                        <strong>開催場所：</strong><br>
                        <span class="internship-place"></span>
                    </p>
                    <p>
                        <strong>最寄り駅：</strong><br>
                        <span class="internship-station"></span>
                    </p>
                    <div>
                        <strong>内容：</strong>
                        <p class="internship-content"></p>
                    </div>
                    <p>
                        <strong>交通費支給：</strong>
                        <span class="internship-carfare"></span>
                    </p>
                    <p>
                        <strong>自費交通費：</strong><br>
                        <span class="internship-carfare-price"></span>
                    </p>
                    <p>
                        <strong>昼食支給：</strong>
                        <span class="internship-lunch"></span>
                    </p>
                    <div>
                        <strong>参加後メモ：</strong>
                        <p class="internship-joined-memo"></p>
                    </div>

                    <button type="button"
                        class="close-details mt-4 cursor-pointer font-semibold text-blue-500 hover:text-blue-800 hover:underline">
                        ▲ 閉じる
                    </button>
                </div>
            </details>
    ...
    @vite('resources/js/internship-index.js')
@endsection
