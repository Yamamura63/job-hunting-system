        ...
        <form method="POST" action="{{ route('company.store') }}" class="w-full max-w-2xl">
            ...
            <div clas="m-1">
                ...
                <div class="rate-form">
                    ...
                    <input id="star3" type="radio"  name="level" value="3" class="hidden" {{ old('rate', 3) == 3 ? 'checked' : '' }}>
            ...
            <div clas="m-1">
                ...
                <div class="flex items-center gap-2">
                    ...
                    <input id="low" type="radio" name="ses_level" value="4">
            ...
            <div clas="m-1">
                ...
                <textarea name="benefits_memo" rows="6"
                    class="body target_length resize-none overflow-y-auto m-2 border rounded w-full"></textarea>
            </div>
...
<script>
    ...
    const target = document.querySelector('.target_length');
