...
@section('content')
    ...
    <div class="p-8">
        <div class="mx-auto max-w-6xl rounded-lg bg-white p-4 sm:p-8 shadow flex justify-center">
            ...
            @endif
            <form id="company-edit-form" data-id="{{ $id }}" class="w-full max-w-2xl">
                @csrf
                @method('PUT')
                <div class="m-3">
                ...
                <div class="m-3">
                    ...
                    <input type="text" name="address" class="w-full m-2 border border-gray-500 rounded" value="">
                </div>

                <div class="m-3">
                    <label class="text-lg font-bold">業種</label><br>
                    <input type="text" name="industry" class="w-full m-2 border border-gray-500 rounded" value="">
                </div>
                ...
                <div class="m-3">
                    ...
                    <div class="ml-4 flex flex-wrap items-center gap-x-2 gap-y-1">
                        ...
                        <input type="number" id="kihon" name="basic_salary" min="0"
                            class="w-20 min-w-0 box-border m-1 text-right border border-gray-500 rounded" value="">
                ...
                <div class="m-3">
                    ...
                    <div class="ml-4">
                        <div class="flex items-center">
                            <input type="time" name="start_time" class="rounded" value="">
                            <p class="p-4">～</p>
                            <input type="time" name="end_time" class="rounded" value="">
                        </div>
                ...
                <div class="m-3">
                    ...
                    <div class="flex flex-col sm:flex-row gap-3 mt-3 min-w-0">
                        <input type="text" name="urls[0][memo]" class="memo w-full sm:w-1/3 border rounded p-2" placeholder="詳細">
                        <input type="url" name="urls[0][url]" class="url w-full sm:flex-1 border rounded p-2" placeholder="https://">
                    </div>
    ...
    <a href="{{ route('companies.index') }}" class="m-3 p-2 hover:bg-slate-300 rounded">
        ← 一覧に戻る
    </a>

    @vite('resources/js/company-edit.js')
